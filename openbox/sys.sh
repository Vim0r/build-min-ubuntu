...
sudo apt-get install feh tint2 lxappearance obmenu qt4-qtconfig menu gnome-icon-theme ubuntu-mono pixmap gtk2-engines-murrine gtk2-engines-pixbuf dmz-cursor-theme -y
